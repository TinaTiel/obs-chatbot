...
@ContextConfiguration(classes = {TwitchChatClientMessagingGatewayWiretapIT.TestConfig.class, TwitchChatClientIntegrationConfig.class})
@ExtendWith(SpringExtension.class)
public class TwitchChatClientMessagingGatewayWiretapIT {
