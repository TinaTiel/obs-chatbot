...
/**
 * A default Event implementation, unique by timestamp and UUID. Comparison operates on timestamp,
 * then id. We use UUIDs as this would work better in distributed scenarios, and we use
 * LocalDateTime to account for location of server that is deployed.
 */
