...
@ContextConfiguration(classes = {SystemController.class, WebSecurityConfig.class})
...
public class SystemControllerTest {
  ...
  void getSystemSettings() throws Exception {
    ...
    mockMvc.perform(get(WebConfig.BASE_PATH + "/system/settings")
  ...
  void saveSystemSettings() throws Exception {
    ...
    // When saved it is ok
    mockMvc.perform(put(WebConfig.BASE_PATH + "/system/settings")
